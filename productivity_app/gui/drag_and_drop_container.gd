...
#
	...
	#if ToDoItem.item_hovered_over == null:
		#return false
#
...
#
	#if is_child_type:
		#_move_child_to_new_index(ToDoItem.item_hovered_over, separator, at_position)
#
...
#
	#_move_child_to_new_index(ToDoItem.item_hovered_over, data_node, at_position)
#
#
...
#) -> void:
	...
	#var child_y_mid_point: float = child_under_mouse.position.y + task_height / 2
		...
		#new_index -= 1
#
	#new_index = clampi(new_index, 0, MAX_CHILDREN)
